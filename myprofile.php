					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li class="current-list-item"><a href="profile.php">Mi perfil</a></li>
								<li>
	...
	<div class="product-section mt-150 mb-150">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text"><?php echo $userDat['userFirstName'].' </span> '.$userDat['userLastName'];?></h3>
						<p>Aqui tienes los datos de tu perfil:</p><br>
						...
						<table class="col-lg-10 offset-lg-2">
							<tr>
								<th>Contraseña: </th>
								<td>*******</td>
								<td><a href="php/sendResetPassword.php" class="cart-btn"> Cambiar contraseña:</a></td>
							</tr>
						</table>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">Mis </span>Retos </h3>
						<p>Aqui estan tus retos subidos a la plataforma.</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<?php
				$retos = obtenerRetos(3,$userDat['username']);
				if (!empty($retos)){
					...
					<div class="col-lg-8 offset-lg-2 text-center">
						<div class="section-title">	
							<p>Vaya, parece que aun no tienes ningun reto subido. x_X</p>
							<p>¡Sube uno ahora mismo!</p><br>
							<a href="" class="cart-btn"> Subir Reto</a>
						</div>
					</div>';
				}
				?>
