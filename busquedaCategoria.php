            ...
            <div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
                        <?php
                            if(isset($_GET['cat'])){
                                $cat_dat = datosCategoria($_GET['cat']);
                                if($cat_dat['existencia'] != 0){
                                    echo '
                                    <h3><span class="orange-text">'.$cat_dat['nombre'].'</h3>
                                    <p>'.$cat_dat['desc'].'</p>
                                    ';
                                }else{
                                    echo '<h3><span class="orange-text">MAMARRACHO QUE ESO NO ESISTE!</h3>';
                                }
                            }
                        ?>
			...
			<div class="row">
				...
				if(isset($_GET['cat'])){
					...
					if (!empty($retos)){
							...
							echo '<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
								<div class="single-product-item">
									<div class="product-image">
										<!-- FUTURA FOTO RETO <a href=""><img src="assets/img/" alt=""></a> -->
									</div>
						...
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="section-title">	
								<p>No hay retos en esta categoria... AUN!.</p>
							</div>
						</div>';
					}
				}else{
